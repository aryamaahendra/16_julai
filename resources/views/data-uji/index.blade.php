<x-app-layout>
   <div class="mt-8 mb-6 rounded-none px-1">
      @include('data-uji.breadcrumbs.index')
      <h1 class="text-2xl font-semibold">Data Uji</h1>
   </div>

   <div x-data="initListDataUji" id="list-data-uji">
      <div class="mb-4 flex items-center justify-between">
         <div class="relative">
            <input type="search" placeholder="Cari data ..." class="input search input-bordered w-full max-w-xs" />
         </div>

         <a href="{{ route('data-uji.create') }}" class="btn">
               ...
               @forelse ($allData as $data)
                  <tr class="">
                     ...
                     <td class="border-inherit">
                        <div class="space-x-1">
                           <a href="{{ route('data-uji.edit', ['data_uji' => $data->id]) }}" class="btn btn-sm">
                              Edit
                           </a>

                           <form delete-form action="{{ route('data-uji.destroy', ['data_uji' => $data->id]) }}"
