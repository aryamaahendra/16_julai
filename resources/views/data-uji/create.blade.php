<x-app-layout>
   <div class="mt-8 mb-6 rounded-none px-1">
      @include('data-uji.breadcrumbs.create')
      <h1 class="text-2xl font-semibold">Tambah Uji</h1>
   </div>

   <form class="bg-base-100 mx-auto max-w-4xl rounded-lg p-6 shadow" action="{{ route('data-uji.store') }}" method="POST">
      @csrf
