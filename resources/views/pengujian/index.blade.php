            ...
            <table class="table w-full">
                ...
                <thead class="bg-base-200 border-b">
                    <tr class="border-gray-200">
                        ...
                        <th colspan="4" class="border border-gray-200 bg-inherit text-center"
                            style="position: unset;">
                            Predicted
                        </th>
                    </tr>
                    <tr class="border-gray-200">
                        @forelse (App\Enums\JenisKerusakan::allWithoutNone() as $class)
                ...
                <tbody class="list divide-y">
                    ...
                    @forelse (App\Enums\JenisKerusakan::allWithoutNone() as $actual)
                        <tr class="border-gray-200">
                            <td role="" class="border border-gray-200 capitalize">{{ $actual }}</td>
                            @forelse (App\Enums\JenisKerusakan::allWithoutNone() as $predicted)
                                @php
